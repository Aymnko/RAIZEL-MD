...
const fs = require('fs');
const ownerNumber = ['963980934390']
const prefix = '.'
...
async function ytinfo(name) {
        ...
        let url = arama[0].url
        let result = { msg : '【⚜️Άήίмέ ⋉⦅💮⦆⋊ ȚŖÏBËŚ⚜️】╠  *📥تحميل الفيديوهات من اليوتوب📤*  ╣\n╚═════════════╝\n\n║📽️ɴᴀᴍᴇ: ' + title2 + '\n\n║👁️ᴠɪᴇᴡs: ' + views + '\n\n║📹 ᴄʜᴀɴɴᴇʟ: ' + author + '\n\n║🖇️ᴜʀʟ: ' + url + '\n\n╚═══════════◈' , 
                      thumbnail : thumbnail ,
                      yuturl: url }
        return result
...
mek = mek.messages[0]
 ...
 //_______________________________________________________________________________________________________________________________________________________   //      
        ...
        case 'ملصق' :
         ...
         await conn.sendMessage(from, { delete: cstic.key })
	       ...
	       v.reply('أين هي الصورة او الفيديو الذي تريد ان تحوله لملصق يا هذا')
        }
              break 
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
  ...
  await conn.sendMessage(from, { delete: filedown.key })	
			...
			await conn.sendMessage(from , { text: 'تعذر تحميل الملف آسف عزيزي\n\n' + e }, { quoted: mek } )
		}
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
	      ...
	      case "انستغرام" :
              case "انستجرام":
		try {
		if (!q) return await conn.sendMessage(from , { text: 'أين هو رابط فيديو الانستغرام الذي تود تحميله عزيزي ' }, { quoted: mek } )
...
await conn.sendMessage(from , { text: 'error' }, { quoted: mek } )  
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
    ...
    const listMessage = {
      text: " \n\n name : " + q + '\n\n ',
      footer: config.FOOTER,
      title: 'NearBot-MD تحميل التطبيقات بواسطة المطور',
...
│ 【⚜️Άήίмέ ⋉⦅💮⦆⋊ ȚŖÏBËŚ⚜️】
╰────────────────────╯ 
https://chat.whatsapp.com/IadcHkIwJ5M6nJ8s2u9yK6
╭────────────────────╮
        الأوامــــــر : menu
╰────────────────────╯
╭────────────────────╮
...
╰────────────────────╯
  ...
  // _ _ _ _ _ _ _ _ __  _ _ _ _ _ _  __  _ _ _ __ _  __ _  _ _ _ _ __ _ _  __  __ _  _ __  _ __ _ _ _  _ __ _  _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ __  __ _  __ _ _ _ _   //   		      
		...
		const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + `FN:` + ' Ⓝⓔⓐⓡ-Ⓑⓞⓣ ' + `\n` // full name
            + 'TEL;type=CELL;type=VOICE;waid=' + '963980934390' + ':+' + '963980934390' + '\n' // WhatsApp ID + phone number
            + 'END:VCARD'
